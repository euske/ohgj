...
Game.prototype.init = function (state, arg)
{
  ...
  function game_finished(e) {
    game.post(function () { game.init(0); });
  }
  if (this.music != null) {
    this.music.pause();
  }
  ...
  case 0:
    ...
    this.scene.init('<b>Whats Cooking Good Looking</b><p>Made with JSCS<p>Press Enter to start.');
  ...
  case 2:
    ...
    this.scene.init(arg);
    this.scene.changed.subscribe(game_finished);
    this.music = null;
    break;
  }
  if (this.music != null) {
